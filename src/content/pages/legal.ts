...
export const privacyPolicy = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        {
          de: 'Auf der Kontaktseite befindet sich eine Karte, die erst nach Ihrem Klick geladen wird. Bis dahin wird nichts von einem fremden Server abgerufen und Ihre IP-Adresse an niemanden übermittelt. Klicken Sie auf „Karte laden“, wird die Darstellung von Google Maps bezogen, einem Dienst der Google Ireland Limited; dabei erhält Google Ihre IP-Adresse und kann Daten in die USA übermitteln. Rechtsgrundlage ist Ihre durch den Klick erklärte Einwilligung nach Art. 6 Abs. 1 lit. a DSGVO; Sie können sie widerrufen, indem Sie die Seite neu laden. Ohne diesen Klick besteht keine Verbindung zu Google.',
          fr: "La page de contact comporte une carte qui n'est chargée qu'après votre clic. Jusque-là, rien n'est appelé auprès d'un serveur tiers et votre adresse IP n'est transmise à personne. Si vous cliquez sur « Charger la carte », l'affichage provient de Google Maps, un service de Google Ireland Limited ; Google reçoit alors votre adresse IP et peut transférer des données vers les États-Unis. La base légale est le consentement exprimé par ce clic, au sens de l'art. 6, par. 1, point a) du RGPD ; vous pouvez le retirer en rechargeant la page. Sans ce clic, aucune connexion à Google n'est établie.",
          en: 'The contact page carries a map that is only loaded once you click. Until then nothing is fetched from any third-party server and your IP address goes nowhere. If you press “Load map”, the view comes from Google Maps, a service of Google Ireland Limited; Google then receives your IP address and may transfer data to the United States. The legal basis is the consent expressed by that click under Art. 6(1)(a) GDPR, and you can withdraw it by reloading the page. Without that click no connection to Google is made.',
        },
      ],
    },
    {
